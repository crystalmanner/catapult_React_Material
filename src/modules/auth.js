...
export const loadUser = createAction(LOAD_USER, () => async (dispatch, getState) => {
  ...
  if (user && user.groups.includes('Publisher')) {
    return response;
  } else {
    localStorage.removeItem("jwt");
    localStorage.removeItem("uid");
    dispatch(routerPush('/no-access'));
    return {};
  }
});
